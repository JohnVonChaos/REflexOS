...
import { FileIcon, UploadIcon, DownloadIcon, CompareIcon, TrashIcon, BookIcon, ExpandIcon, CollapseIcon, SaveIcon, CrystalIcon, GlobeIcon, SpeakerIcon, FolderIcon, FolderOpenIcon, DocumentTextIcon, NetworkIcon } from './icons';
